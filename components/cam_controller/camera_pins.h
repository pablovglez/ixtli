...
// ESP-EYE PIN Map
#elif defined(CONFIG_BOARD_CAMERA_MODEL_ESP_EYE)
...
#elif defined(CONFIG_BOARD_ESP32CAM_AITHINKER)
...
#elif defined(CONFIG_BOARD_CAMERA_MODEL_TTGO_T_JOURNAL)
...
#elif defined(CAMERA_MODEL_ESP32S3_ETH_CAM)
